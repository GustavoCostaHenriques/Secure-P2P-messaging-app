...
public final class PeerServer extends Thread {
    ...
    public void run() {
        try {
            while (true) { // Infinite loop to keep the server running and accepting client connections.
                ...
                PeerHandler peerHandler = new PeerHandler(sslSocket); // Create a new PeerHandler for the connection
    ...
    public void sendMessage(Message message) throws Exception {
        peer = new Peer(message.getReceiver().getId(), message.getReceiver().getPort()); // Create a Peer instance for
                                                                                         // the receiver
