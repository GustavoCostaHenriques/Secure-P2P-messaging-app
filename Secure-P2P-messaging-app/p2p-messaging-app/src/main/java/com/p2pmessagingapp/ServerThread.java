...
public class ServerThread extends Thread {
    ...
    public void run() {
        try {
            ...
            SSLSocket sslSocket = (SSLSocket) sslServerSocket.accept();  // Aceita a conexão e retorna um SSLSocket
            ServerThreadThread serverThreadThread = new ServerThreadThread(sslSocket, this); 
